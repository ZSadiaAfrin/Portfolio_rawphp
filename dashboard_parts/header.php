<?php
$id = $_SESSION['id'];
$select = "SELECT * FROM user_tables WHERE id=$id";
$select_res = mysqli_query($database_connection, $select);
$after_assoc = mysqli_fetch_assoc($select_res);
//message
$select_msg = "SELECT * FROM messages WHERE status=0";
$select_res_msg = mysqli_query($database_connection, $select_msg);


$count_msg = "SELECT COUNT(*) as total FROM messages WHERE status=0";
$count_msg_res = mysqli_query($database_connection, $count_msg);
$after_assoc_msg = mysqli_fetch_assoc($count_msg_res);
?>
...
<head>
    ...
    <link rel="stylesheet" href="/sadia/dashboard_asset/vendor/chartist/css/chartist.min.css">
    <link href="/sadia/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="/sadia/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/sadia/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/sadia/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/sadia/dashboard_asset/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <div class="pulse-css"><?= $after_assoc_msg['total'] ?></div>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
                                        <ul class="timeline">
                                                ...
                                                <?php foreach ($select_res_msg as $key => $message) {
                                                    # code...
                                                ?>
                                                <li>
                                                <a href="../message/message_view.php?id=<?=$message['id']?>">
                                                    <div class="timeline-panel">
                                                        <div class="media mr-2">
                                                            <img alt="image" width="50" src="../dashboard_asset/images/avatar/1.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <h6 class="mb-1"><?=$message['name']?> send message.</h6>
                                                            <small class="d-block"><?=$message['date']?></small>
                                                        </div>
                                                    </div>
                                                    </a>
                                                </li>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <?php if (isset($after_assoc['photo']) == null) { ?>
                                        <img src="/sadia/dashboard_asset/images/profile/17.jpg" width="20" alt="" />
                                    <?php } else { ?>
                                        <img src="/sadia/uploads/user/<?= $after_assoc['photo'] ?>" width="20" alt="" />
                                    <?php } ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/sadia/user/profile.php" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/sadia/logout.php" class="dropdown-item ai-icon">
                ...
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/dashboard.php">Dashboard</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/user/user.php">User List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/logo/add_logo.php">Add logo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/banner/add_banner.php">Add banner</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/social/social.php">Social Icon</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/about/about.php">About my information</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/blog/blog.php">Add new blog</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/testimonial/testimonial.php">Add testimonial</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/project/project.php">Add new project</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/work/work.php">Add new skill</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/skill/skill.php">Add new skill</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/message/message.php">Add new message</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/sadia/counter/counter.php">Add new counter</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
